...
Grammarly records no language anywhere in the `.docx`, so this is a pure heuristic (backed by [`flourite`](https://www.npmjs.com/package/flourite)). It is reliable for things like JSON and shell, shakier on JavaScript-vs-TypeScript, and **always needs a human pass**.
