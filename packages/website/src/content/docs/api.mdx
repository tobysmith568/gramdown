...
It is backed by [`flourite`](https://www.npmjs.com/package/flourite)'s heuristic scorer and, like every guess here, needs a human pass. It is a separate subpath export so callers who don't want it don't pay for `flourite`.
